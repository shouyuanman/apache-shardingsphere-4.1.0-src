package com.msy.sharding.jdbc.demo.config;
...
public class MyShardingSphereConfig implements EnvironmentAware {
    ...
    public MyShardingSphereConfig(SpringBootShardingRuleConfigurationProperties shardingRule,
